...
#            linea = data[0]
            ...
            for k in range(nx):
                ...
                ficheroGuardar = 'out_jose/sensorVel_' + str(k+1) + '.dat'
                #fileW = open(os.path.join(savePath,ficheroGuardar), 'w')
                fileW = open(ficheroGuardar, 'w')
            ...
            #        print('Sensor ' + str(k+1) + ' de ' + str(nx) + '.')
                    ...
                    ficheroGuardar = 'out_jose/sensorVel_' + str(k+1) + '.dat'
                    #fileW = open(os.path.join(savePath,ficheroGuardar), 'a')
                    fileW = open(ficheroGuardar, 'a')
